...
void PROCESS_Message(signed_message *mess) 
{
  ...
  //sahiti
  struct timeval sahiti_now,sahiti_update,sahiti_po_request,sahiti_po_ack,sahiti_matrix,sahiti_pp,sahiti_p,sahiti_commit,sahiti_diff,sahiti_po_aru;
  ...
  case PO_ACK:
  	...
  	if(SAHITI){
		...
		//sahiti_diff=diffTime(sahiti_now,sahiti_po_request);
        	...
        	//printf("po_ack-po_req in msec=%lu\n",(sahiti_diff.tv_sec*1000)+(sahiti_diff.tv_usec/1000));
        	printf("======================================\n");
        	}
  ...
  case PO_ARU:
  	...
  	if(SAHITI){
		...
		//sahiti_diff=diffTime(sahiti_now,sahiti_po_ack);
        	...
        	//printf("po_aru-po_ack in msec=%lu\n",(sahiti_diff.tv_sec*1000)+(sahiti_diff.tv_usec/1000));
        	printf("======================================\n");
        	}
  ...
  case PROOF_MATRIX:
  	...
  	if(SAHITI){
		...
		//sahiti_diff=diffTime(sahiti_now,sahiti_po_aru);
        	...
        	//printf("matrix-po_aru in msec=%lu\n",(sahiti_diff.tv_sec*1000)+(sahiti_diff.tv_usec/1000));
        	printf("======================================\n");
        	}
